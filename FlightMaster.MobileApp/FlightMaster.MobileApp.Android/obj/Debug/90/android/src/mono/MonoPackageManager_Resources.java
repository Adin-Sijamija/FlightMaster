...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "FlightMaster.MobileApp.Android.dll" comes first in this list. */
		"FlightMaster.MobileApp.Android.dll",
		"dotMorten.Xamarin.Forms.AutoSuggestBox.dll",
		"FlightMaster.MobileApp.dll",
